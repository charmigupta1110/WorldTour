...
$res=mysqli_fetch_array($query);
 	...
 	$flight_time=$_POST['flight_time'];
 			...
 			$update=mysqli_query($cn,"update  Flight set id=$id,destination=$d,f_from=$depart_in,class=$class,travellers=$travellers,flight_name=$flight_name,flight_time=$flight_time where id=$id");
?>
<h4 align="left">
<label for ="name" > Origin:Mumbai</label>
 <br>
<label for="destination"> Destination:</label>
<select name="des" value="<?php echo $res['destination'];?>">
...
<input type="date" name="d_in" value="<?php echo$res['f_from'];?>">
<br>
<label for="flight_name">Flight Name</label>
<select name="flight_name" value="<?php echo $res['flight_name'];?>">
...
<select name="flight_time"value="<?php echo $res['flight_time'];?>">
...
<input type="text" name="t"  value="<?php echo $res['travellers'];?>" required>
<br>
<label for =class > Class: </label><br>
<input type="radio"  name="class"  value="<?php echo$res['class'];?>">
